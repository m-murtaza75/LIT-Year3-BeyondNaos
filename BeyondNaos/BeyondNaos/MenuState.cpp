...
MenuState::MenuState(GameStateManager& gsm):gsm(gsm), background("Resources/Backgrounds/landscape.gif",1)
{
...
void MenuState::Init() {
	...
	MenuHeader.setString("BEYOND NAOS"); 
...
void MenuState::selected()
{
	...
	{
		//Leaderboard
		gsm.SetState(GameStateManager::TOPSCORE);
		gsm.Init();
	}
